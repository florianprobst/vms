<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Flangetype'), ['action' => 'edit', $flangetype->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Flangetype'), ['action' => 'delete', $flangetype->id], ['confirm' => __('Are you sure you want to delete # {0}?', $flangetype->id)]) ?> </li>
...
<div class="flangetypes view large-9 medium-8 columns content">
    <h3><?= h($flangetype->id) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($flangetype->valves)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($flangetype->valves as $valves): ?>
            <tr>
                <td><?= h($valves->id) ?></td>
